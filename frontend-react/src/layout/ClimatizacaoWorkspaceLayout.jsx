...
const MENU = [
  {
    label: "Visão Geral",
    icon: Gauge,
    to: "/v2/linha-branca/climatizacao",
    exact: true,
  },
  {
    label: "Triagem",
    icon: ClipboardCheck,
    to: "/v2/linha-branca/climatizacao/triagem",
  },
  {
    label: "Reparos",
    icon: Wrench,
    to: "/v2/linha-branca/climatizacao/reparos",
  },
  {
    label: "Bancada de Testes",
    icon: TestTubeDiagonal,
    to: "/v2/linha-branca/climatizacao/testes",
  },
];
      ...
      >
        ...
        {!collapsed && (
          <div className="px-4 pt-4">
            <button
              type="button"
              onClick={() => navigate("/v2/linha-branca")}
        ...
        <div className={collapsed ? "px-3 pt-5" : "px-4 pt-5"}>
          {!collapsed ? (
            ...
            <div className="flex h-10 items-center justify-center rounded-xl bg-white/5 text-violet-200 ring-1 ring-white/10">
        ...
        <header className="sticky top-0 z-30 h-[72px] border-b border-slate-200 bg-white/95 backdrop-blur">
          <div className="flex h-full items-center gap-3 px-4 lg:px-6">
            ...
            <div className="ml-auto flex items-center gap-2.5">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-violet-50 text-[#4C1D95]">
                ...
                return (
                  <NavLink
                    ...
                    className={({ isActive }) => `
                      ...
                      ${isActive ? "bg-white text-[#4C1D95]" : "text-white/70"}
                    `}
                  >
