...
const MENU = [
  {
    label: "Visão Geral",
    icon: Gauge,
    to: "/v2/linha-branca/lavadoras",
    exact: true,
  },
  {
    label: "Triagem",
    icon: ClipboardCheck,
    to: "/v2/linha-branca/lavadoras/triagem",
  },
  {
    label: "Reparos",
    icon: Wrench,
    to: "/v2/linha-branca/lavadoras/reparos",
  },
  {
    label: "Bancada de Testes",
    icon: TestTubeDiagonal,
    to: "/v2/linha-branca/lavadoras/testes",
  },
];
...
export default function LavadorasWorkspaceLayout() {
