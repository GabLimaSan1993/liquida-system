...
import {
  ...
  PlusCircle, Box, Store, ClipboardList as Inventory,
} from "lucide-react";
...
function MenuAssurant({ onClose, telas }) {
  ...
  return (
    <>
      ...
      <CollapseGroup icon={Package} label="Assurant Warehouse" paths={["/assurant", "/b2b", "/b2c", "/trocas-b2c", "/inventario"]}>
        ...
        {tem("/inventario") && (
          <NavItem to="/inventario"         icon={Inventory}       label="Inventário Cíclico"    indent onClick={onClose} />
        )}
