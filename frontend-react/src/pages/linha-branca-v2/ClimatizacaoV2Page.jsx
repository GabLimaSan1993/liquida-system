...
const INDICADORES = [
  { label: "Aguardando triagem", value: "—", icon: ClipboardCheck },
  { label: "Em reparo", value: "—", icon: Wrench },
  { label: "Em testes", value: "—", icon: TestTubeDiagonal },
  { label: "Concluídas", value: "—", icon: CheckCircle2 },
];
...
const FLUXO = [
  {
    numero: "01",
    titulo: "Triagem",
    descricao: "Aferições funcionais, elétricas, corrente, pressão e inspeção estética.",
  },
  {
    numero: "02",
    titulo: "Reparo",
    descricao: "Execução das intervenções mecânicas, elétricas e/ou estéticas necessárias.",
  },
  {
    numero: "03",
    titulo: "Bancada de Testes",
    descricao: "Validação técnica do equipamento após a intervenção.",
  },
  {
    numero: "04",
    titulo: "Encaminhamento",
    descricao: "Aprovado segue para Higienização; reprovação retorna à especialidade técnica.",
  },
];
      ...
      <div className="flex flex-col gap-5 border-b border-slate-200 pb-7 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
            Acompanhamento operacional do fluxo de equipamentos de climatização.
          </p>
        </div>
      ...
      <section className="mt-10">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Jornada da OS dentro da operação de Climatização.
          </p>
        </div>
