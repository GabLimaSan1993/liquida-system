...
const FLUXO = [
  ...
  },
  {
    ...
    descricao: "Validação técnica após intervenção.",
  },
  {
    numero: "04",
      ...
      <div className="flex flex-col gap-5 border-b border-slate-200 pb-7 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
            Acompanhamento operacional do fluxo de refrigeração.
          </p>
        </div>
        ...
        <div className="mb-5 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Jornada da OS dentro da operação de Refrigeração.
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white">
          ...
          <div className="flex min-h-[220px] items-center justify-center px-5 py-8 text-center">
            <div>
              ...
              <div className="mt-1 text-xs text-slate-400">
                Vamos medir tempos entre as etapas do processo.
              </div>
            </div>
          </div>
        </div>
