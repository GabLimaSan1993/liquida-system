...
export default function BancadaTestesRefrigeracaoV2Page() {
  ...
  async function salvar() {
    ...
    try {
      ...
      const novoStatus = form.aprovado
        ? "Limpeza"
        : "Triado";

      const novaEtapa = form.aprovado
        ? "Limpeza"
        : form.etapa_retorno;

      const novaArea = form.aprovado
        ? "Limpeza"
        : form.etapa_retorno;
    ...
    <div className="mx-auto max-w-[1500px]">
      ...
      <div className="border-b border-slate-200 pb-7">
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
          Valide o equipamento após o reparo e defina sua liberação ou retorno técnico.
        </p>
      </div>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div className="mt-1 text-xs text-slate-500">
                Equipamento retorna para reparo.
              </div>
            </div>
          </button>
        </div>
